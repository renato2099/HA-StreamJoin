...
echo "kafka=localhost:9092 zk=localhost:2181 missing=0 sf=1 tuples=10000 pcompletion=0.9 psuccess=0.1" >> auctionProducer.log
java -jar $JARS/target/auction-producer.jar kafka=localhost:9092 zk=localhost:2181 missing=0 sf=1 tuples=10000 pcompletion=0.9 psuccess=0.1 >> auctionProducer.log
echo "kafka=localhost:9092 zk=localhost:2181 missing=0 sf=1 tuples=10000 bid_ratio=10 psuccess=0.1" >> bidProducer.log
#java -jar $JARS/target/bid-producer.jar kafka=localhost:9092 zk=localhost:2181 missing=0 sf=1 tuples=10000 bid_ratio=10 psuccess=0.1 >> bidProducer.log