...
#java -jar $JARS/target/auction-producer.jar kafka=localhost:9092 zk=localhost:2181 missing=0 sf=1 tuples=10 pcompletion=0.9
#java -jar $JARS/target/bid-producer.jar kafka=localhost:9092 zk=localhost:2181 missing=16 sf=1 tuples=10 bid_ratio=2 psuccess=0.1